...
module.exports = __webpack_require__(4535);
...
var utils = __webpack_require__(8443);
var settle = __webpack_require__(7720);
var cookies = __webpack_require__(8338);
var buildURL = __webpack_require__(7395);
var buildFullPath = __webpack_require__(2202);
var parseHeaders = __webpack_require__(3347);
var isURLSameOrigin = __webpack_require__(5267);
var transitionalDefaults = __webpack_require__(5306);
var AxiosError = __webpack_require__(3962);
var CanceledError = __webpack_require__(54);
var parseProtocol = __webpack_require__(3813);
...
var utils = __webpack_require__(8443);
var bind = __webpack_require__(5578);
var Axios = __webpack_require__(6048);
var mergeConfig = __webpack_require__(2380);
var defaults = __webpack_require__(7946);
...
axios.CanceledError = __webpack_require__(54);
axios.CancelToken = __webpack_require__(1304);
axios.isCancel = __webpack_require__(3793);
axios.VERSION = (__webpack_require__(7105).version);
axios.toFormData = __webpack_require__(8279);

// Expose AxiosError class
axios.AxiosError = __webpack_require__(3962);
...
axios.spread = __webpack_require__(2078);

// Expose isAxiosError
axios.isAxiosError = __webpack_require__(4358);
...
var utils = __webpack_require__(8443);
var buildURL = __webpack_require__(7395);
var InterceptorManager = __webpack_require__(4667);
var dispatchRequest = __webpack_require__(8200);
var mergeConfig = __webpack_require__(2380);
var buildFullPath = __webpack_require__(2202);
var validator = __webpack_require__(2301);
...
var isAbsoluteURL = __webpack_require__(5411);
var combineURLs = __webpack_require__(1451);
...
var utils = __webpack_require__(8443);
var transformData = __webpack_require__(1944);
var isCancel = __webpack_require__(3793);
var defaults = __webpack_require__(7946);
var CanceledError = __webpack_require__(54);
...
var utils = __webpack_require__(8443);
var normalizeHeaderName = __webpack_require__(8231);
var AxiosError = __webpack_require__(3962);
var transitionalDefaults = __webpack_require__(5306);
var toFormData = __webpack_require__(8279);
...
function getDefaultAdapter() {
  ...
  if (typeof XMLHttpRequest !== 'undefined') {
    ...
    adapter = __webpack_require__(7707);
...
var defaults = {
  ...
  env: {
    FormData: __webpack_require__(498)
  },
...
var VERSION = (__webpack_require__(7105).version);
var AxiosError = __webpack_require__(3962);
...
var axios = __webpack_require__(2418);
...
var utils = __webpack_require__(8443);
;// CONCATENATED MODULE: ./node_modules/@vespaiach/axios-fetch-adapter/index.js
    ...
    return new Promise((resolve, reject) => {
        if (data instanceof Error) {
            ...
            Object.prototype.toString.call(config.settle) === '[object Function]'
                ...
                : settle_default()(resolve, reject, data);
        }
    });
}
...
function createRequest(config) {
    ...
    if (method !== 'GET' && method !== 'HEAD') {
        ...
        if ((0,utils.isFormData)(options.body) && (0,utils.isStandardBrowserEnv)()) {
    ...
    if (!(0,utils.isUndefined)(config.withCredentials)) {
        options.credentials = config.withCredentials ? 'include' : 'omit';
    }

    const fullPath = buildFullPath_default()(config.baseURL, config.url);
    const url = buildURL_default()(fullPath, config.params, config.paramsSerializer);
...
var _AppearanceTheme$Ligh, _AppearanceTheme$Dark, _animationSourcesMap;
...
var FREE_GBS_ANCHOR = 'free-gbs';
var AnimationState = /*#__PURE__*/function (AnimationState) {
  AnimationState["VpnDisabledIdle"] = "vpnDisabledIdle";
  AnimationState["VpnEnabled"] = "vpnEnabled";
  AnimationState["VpnDisabled"] = "vpnDisabled";
  AnimationState["VpnConnecting"] = "vpnConnecting";
  AnimationState["VpnDisconnecting"] = "vpnDisconnecting";
  AnimationState["VpnSwitchingLocation"] = "vpnSwitchingLocation";
  return AnimationState;
}({});
var AnimationEvent = /*#__PURE__*/function (AnimationEvent) {
  AnimationEvent["VpnConnected"] = "vpnConnected";
  AnimationEvent["VpnDisconnected"] = "vpnDisconnected";
  AnimationEvent["AnimationEnded"] = "animationEnded";
  AnimationEvent["LocationSelected"] = "locationSelected";
  AnimationEvent["VpnDisconnectedRetrying"] = "vpnDisconnectedRetrying";
  AnimationEvent["ExclusionScreenDisplayed"] = "exclusionScreenDisplayed";
  return AnimationEvent;
}({});
var MOTION_FOLDER_PATH = '../../../assets/motion/';
var animationSourcesMap = (_animationSourcesMap = {}, _defineProperty(_animationSourcesMap, AppearanceTheme.Light, (_AppearanceTheme$Ligh = {}, _defineProperty(_AppearanceTheme$Ligh, AnimationState.VpnEnabled, "".concat(MOTION_FOLDER_PATH, "on-light.webm")), _defineProperty(_AppearanceTheme$Ligh, AnimationState.VpnSwitchingLocation, ''), _defineProperty(_AppearanceTheme$Ligh, AnimationState.VpnDisabled, "".concat(MOTION_FOLDER_PATH, "off-light.webm")), _defineProperty(_AppearanceTheme$Ligh, AnimationState.VpnDisabledIdle, "".concat(MOTION_FOLDER_PATH, "off-light.webm")), _defineProperty(_AppearanceTheme$Ligh, AnimationState.VpnConnecting, "".concat(MOTION_FOLDER_PATH, "switch-on-light.webm")), _defineProperty(_AppearanceTheme$Ligh, AnimationState.VpnDisconnecting, "".concat(MOTION_FOLDER_PATH, "switch-off-light.webm")), _AppearanceTheme$Ligh)), _defineProperty(_animationSourcesMap, AppearanceTheme.Dark, (_AppearanceTheme$Dark = {}, _defineProperty(_AppearanceTheme$Dark, AnimationState.VpnEnabled, "".concat(MOTION_FOLDER_PATH, "on-dark.webm")), _defineProperty(_AppearanceTheme$Dark, AnimationState.VpnSwitchingLocation, ''), _defineProperty(_AppearanceTheme$Dark, AnimationState.VpnDisabled, "".concat(MOTION_FOLDER_PATH, "off-dark.webm")), _defineProperty(_AppearanceTheme$Dark, AnimationState.VpnDisabledIdle, "".concat(MOTION_FOLDER_PATH, "off-dark.webm")), _defineProperty(_AppearanceTheme$Dark, AnimationState.VpnConnecting, "".concat(MOTION_FOLDER_PATH, "switch-on-dark.webm")), _defineProperty(_AppearanceTheme$Dark, AnimationState.VpnDisconnecting, "".concat(MOTION_FOLDER_PATH, "switch-off-dark.webm")), _AppearanceTheme$Dark)), _animationSourcesMap);
